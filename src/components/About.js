            ...
            <section className='bg-gray-900 h-[100%]'>
                ...
                <div className=' py-8 '>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <div>
                            ...
                            <p className='text-[#b0aa9c] px-4 text-4xl leading-snug'>We Help Thousands of Children to Get Their Education</p>
                        </div>
                        {/* text */}
                        <div className='text-[#aba8a8] px-4 py-4 leading-normal text-[16px] font-serif'>
                ...
                <div className='flex gap-6 justify-center items-center flex-col md:flex-row md:justify-evenly pb-6'>
                    ...
                    <div className='flex justify-center flex-col items-center' >
                        ...
                        <h1 className='py-4 text-2xl text-gray-400'>Start Donating</h1>
                    </div>
                    {/* second */}
                    <div className='flex justify-center flex-col items-center py-8' >
                        ...
                        <h1 className='py-4 text-2xl text-gray-400'>Join Our Community</h1>
                    </div>
                    {/* third */}
                    <div className='flex justify-center flex-col items-center' >
                        <div className='bg-[#d49a3a] m-auto rounded-full w-28 h-28 relative'>
                        ...
                        <h1 className='py-4 text-2xl text-gray-400'>Be A Volunteer</h1>
                    </div>
                </div>
            </section>
        </>
