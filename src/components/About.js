                    ...
                    <div className='flex flex-col'>
                        ...
                        <div className='md:py-8 md:text-center' data-aos="fade-down">
                            ...
                            <p className='text-[#b0aa9c] px-4 text-2xl md:text-5xl md:leading-normal'>
                                We Help Thousands of Children's to Get Their Education
                            </p>
                        </div>
                        {/* text */}
                        <div className='text-[#aba8a8] px-4 py-4 leading-normal text-[16px] md:text-[22px]' data-aos="fade-up">
                            <p>Nikk Social Walfare Foudation, a social development organization, is directly benefitting thousands of children and their families every year. We have several live welfare projects on education, healthcare, livelihood, and women's empowerment in all over Chhattigarh.</p>
                            <br />
