                    ...
                    <div className='flex flex-col md:flex-row md:justify-evenly'>
                        ...
                        <div className='flex flex-col items-center px-4 '>
                            <div className='flex items-center justify-center'>
                                <iframe className='h-[100%] w-[100%] sm:h-[300px] sm:w-[500px] md:h-[500px] md:w-[800px]' src="https://www.youtube.com/embed/XFKD04ufib8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>

                            <div className='flex flex-col items-center text-center'>
                                <p className='text-2xl capitalize pt-4 hover:text-[#d49a35]'>Save Hasdeo Forest</p>
                                <p className='py-4 px-6 tex'>NIKK Social Welfare Foundation के तरफ से आप सभी प्रदेशवासियों तथा देश के सभी लोगों से निवेदन है कि ग्राम हरिहरपुर ( छत्तीसगढ़) में चल रहे हसदेव अरण्य बचाओ महाभियान में अपनी भागीदारी दे और  तीन लाख से अधिक वृक्षों को कटने से बचाए।
